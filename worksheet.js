...
const WORKSHEET_DAYS = [
  ...
  },
  {
    ...
    rows: [
      ...
      row("가다", "go", "went", "I went to a festival.", "나는 축제에 갔어.", { img: "img/went.png", prompt: "a kid at a colorful festival with lanterns and balloons", art: "festival", textbook: true }),
      ...
      row("만들다", "make", "made", "I made cookies.", "나는 쿠키를 만들었어.", { img: "img/made.png", prompt: "a kid making cookies in a kitchen with dough and a tray", art: "cookies", textbook: true }),
    ],
  },
  {
    ...
    rows: [
      ...
      row("돕다", "help", "helped", "I helped my mom.", "나는 엄마를 도왔어.", { img: "img/helped.png", prompt: "a kid helping mom wash dishes in the kitchen", art: "help" }),
      row("씻다", "wash", "washed", "I washed my hands.", "나는 손을 씻었어.", { img: "img/washed.png", art: "wash" }),
      row("청소하다", "clean", "cleaned", "I cleaned my room.", "나는 내 방을 청소했어.", { img: "img/cleaned.png", prompt: "a kid cleaning a bedroom with a broom", art: "clean" }),
      row("요리하다", "cook", "cooked", "I cooked ramyeon.", "나는 라면을 끓였어.", { img: "img/cooked.png", prompt: "a kid cooking ramyeon noodles in a pot on the stove", art: "ramyeon" }),
      row("열다", "open", "opened", "I opened the door.", "나는 문을 열었어.", { img: "img/opened.png", art: "door" }),
      row("닫다", "close", "closed", "I closed the window.", "나는 창문을 닫았어.", { img: "img/closed.png", prompt: "a kid closing a window in a bedroom", art: "window" }),
    ],
  },
  {
    ...
    rows: [
      row("보다", "see", "saw", "I saw fireworks.", "나는 불꽃놀이를 봤어.", { img: "img/saw.png", prompt: "a kid watching colorful fireworks in the night sky", art: "fireworks" }),
      ...
      row("노래하다", "sing", "sang", "I sang a song.", "나는 노래를 불렀어.", { img: "img/sang.png", prompt: "a kid singing with a microphone, music notes around", art: "singing" }),
      row("주다", "give", "gave", "I gave a gift to my friend.", "나는 친구에게 선물을 줬어.", { img: "img/gave.png", prompt: "a kid giving a gift box to a friend", art: "present" }),
      row("가져가다", "take", "took", "I took a photo.", "나는 사진을 찍었어.", { img: "img/took.png", prompt: "a kid taking a photo with a camera", art: "photobooth" }),
  ...
  },
  {
    ...
    rows: [
      row("보다", "look", "looked", "I looked at the stars.", "나는 별을 바라봤어.", { img: "img/looked.png", prompt: "a kid looking up at a starry night sky", art: "camping" }),
      row("듣다", "listen", "listened", "I listened to music.", "나는 음악을 들었어.", { img: "img/listened.png", art: "music" }),
      row("원하다", "want", "wanted", "I wanted ice cream.", "나는 아이스크림을 원했어.", { img: "img/wanted.png", prompt: "a kid looking at an ice cream cone with sparkling eyes", art: "bingsu" }),
      row("좋아하다", "like", "liked", "I liked the movie.", "나는 그 영화가 좋았어.", { img: "img/liked.png", prompt: "a kid smiling with a thumbs up in front of a movie screen", art: "movies" }),
