...
const WORKSHEET_DAYS = [
  {
    ...
    rows: [
      row("참가하다", "join", "joined", "I joined the soccer club.", "나는 축구 클럽에 가입했어.", { img: "img/supplementary/joined.webp", prompt: "a boy joining a soccer club, kids in soccer uniforms waving", art: "soccer" }),
      row("보다", "watch", "watched", "I watched a movie.", "나는 영화를 봤어.", { img: "img/supplementary/watched.webp", prompt: "a kid watching a movie with popcorn on a sofa", art: "movies" }),
      row("방문하다", "visit", "visited", "I visited my grandmother.", "나는 할머니를 찾아뵀어.", { img: "img/supplementary/visited.webp", prompt: "a kid visiting grandmother at her house, grandmother smiling at the door", art: "grandmother", textbook: true }),
      row("배우다", "learn", "learned", "I learned taekwondo.", "나는 태권도를 배웠어.", { img: "img/supplementary/learned.webp", prompt: "a kid in white taekwondo uniform kicking", art: "taekwondo" }),
  ...
  },
  {
    ...
    rows: [
      row("가지다", "have", "had", "I had a sleepover.", "나는 친구 집에서 자고 놀았어.", { img: "img/supplementary/had.webp", prompt: "two kids having a sleepover with pillows and blankets at night", art: "sleepover" }),
      row("오다", "come", "came", "I came to school.", "나는 학교에 왔어.", { img: "img/came.png", art: "school" }),
      row("얻다 / 받다", "get", "got", "I got a present.", "나는 선물을 받았어.", { img: "img/supplementary/got.webp", prompt: "a happy kid holding a wrapped gift box with a ribbon", art: "present" }),
      ...
      row("서다", "stand", "stood", "I stood in line.", "나는 줄을 섰어.", { img: "img/supplementary/stood.webp", prompt: "kids standing in a line at school waiting", art: "school" }),
      row("가다", "go", "went", "I went to a festival.", "나는 축제에 갔어.", { img: "img/supplementary/went.webp", prompt: "a kid at a colorful festival with lanterns and balloons", art: "festival", textbook: true }),
      row("하다", "do", "did", "I did my homework.", "나는 숙제를 했어.", { img: "img/supplementary/did.webp", prompt: "a kid doing homework at a desk with a pencil", art: "homework" }),
      row("만들다", "make", "made", "I made cookies.", "나는 쿠키를 만들었어.", { img: "img/supplementary/made.webp", prompt: "a kid making cookies in a kitchen with dough and a tray", art: "cookies", textbook: true }),
    ],
  },
  {
    ...
    rows: [
      ...
      row("돕다", "help", "helped", "I helped my mom.", "나는 엄마를 도왔어.", { img: "img/supplementary/helped.webp", prompt: "a kid helping mom wash dishes in the kitchen", art: "help" }),
      row("씻다", "wash", "washed", "I washed my hands.", "나는 손을 씻었어.", { img: "img/washed.png", art: "wash" }),
      row("청소하다", "clean", "cleaned", "I cleaned my room.", "나는 내 방을 청소했어.", { img: "img/supplementary/cleaned.webp", prompt: "a kid cleaning a bedroom with a broom", art: "clean" }),
      row("요리하다", "cook", "cooked", "I cooked ramyeon.", "나는 라면을 끓였어.", { img: "img/supplementary/cooked.webp", prompt: "a kid cooking ramyeon noodles in a pot on the stove", art: "ramyeon" }),
      row("열다", "open", "opened", "I opened the door.", "나는 문을 열었어.", { img: "img/opened.png", art: "door" }),
      row("닫다", "close", "closed", "I closed the window.", "나는 창문을 닫았어.", { img: "img/supplementary/closed.webp", prompt: "a kid closing a window in a bedroom", art: "window" }),
    ],
  },
  {
    ...
    rows: [
      row("보다", "see", "saw", "I saw fireworks.", "나는 불꽃놀이를 봤어.", { img: "img/supplementary/saw.webp", prompt: "a kid watching colorful fireworks in the night sky", art: "fireworks" }),
      row("자다", "sleep", "slept", "I slept well.", "나는 잘 잤어.", { img: "img/supplementary/slept.webp", prompt: "a kid sleeping peacefully in bed with a teddy bear, moon outside", art: "sleepover" }),
      ...
      row("노래하다", "sing", "sang", "I sang a song.", "나는 노래를 불렀어.", { img: "img/supplementary/sang.webp", prompt: "a kid singing with a microphone, music notes around", art: "singing" }),
      row("주다", "give", "gave", "I gave a gift to my friend.", "나는 친구에게 선물을 줬어.", { img: "img/supplementary/gave.webp", prompt: "a kid giving a gift box to a friend", art: "present" }),
      row("가져가다", "take", "took", "I took a photo.", "나는 사진을 찍었어.", { img: "img/supplementary/took.webp", prompt: "a kid taking a photo with a camera", art: "photobooth" }),
      row("말하다", "say", "said", "I said hello.", "나는 안녕이라고 말했어.", { img: "img/supplementary/said.webp", prompt: "a kid waving and saying hello with a speech bubble", art: "talk" }),
  ...
  },
  {
    ...
    rows: [
      row("보다", "look", "looked", "I looked at the stars.", "나는 별을 바라봤어.", { img: "img/supplementary/looked.webp", prompt: "a kid looking up at a starry night sky", art: "camping" }),
      row("듣다", "listen", "listened", "I listened to music.", "나는 음악을 들었어.", { img: "img/listened.png", art: "music" }),
      row("원하다", "want", "wanted", "I wanted ice cream.", "나는 아이스크림을 원했어.", { img: "img/supplementary/wanted.webp", prompt: "a kid looking at an ice cream cone with sparkling eyes", art: "bingsu" }),
      row("좋아하다", "like", "liked", "I liked the movie.", "나는 그 영화가 좋았어.", { img: "img/supplementary/liked.webp", prompt: "a kid smiling with a thumbs up in front of a movie screen", art: "movies" }),
      row("사용하다", "use", "used", "I used a computer.", "나는 컴퓨터를 사용했어.", { img: "img/supplementary/used.webp", prompt: "a kid using a computer at a desk", art: "computer" }),
  ...
  },
  {
    ...
    rows: [
      row("가르치다", "teach", "taught", "I taught my dog a trick.", "나는 강아지에게 재주를 가르쳤어.", { img: "img/supplementary/taught.webp", prompt: "a kid teaching a puppy to sit, holding a treat", art: "help" }),
      row("기르다", "grow", "grew", "I grew tomatoes.", "나는 토마토를 길렀어.", { img: "img/supplementary/grew.webp", prompt: "a kid watering tomato plants in a garden", art: "tomatoes" }),
      ...
      row("타다", "ride", "rode", "I rode a bike.", "나는 자전거를 탔어.", { img: "img/supplementary/rode.webp", prompt: "a kid riding a bicycle on a park road in autumn", art: "bike" }),
      row("쓰다", "write", "wrote", "I wrote a letter.", "나는 편지를 썼어.", { img: "img/wrote.png", art: "letter" }),
      row("그리다", "draw", "drew", "I drew a picture.", "나는 그림을 그렸어.", { img: "img/supplementary/drew.webp", prompt: "a kid drawing a picture with crayons on paper", art: "paint" }),
      row("만나다", "meet", "met", "I met my friend.", "나는 친구를 만났어.", { img: "img/supplementary/met.webp", prompt: "two kids meeting and waving at each other in a park", art: "talk" }),
      row("놓다", "put", "put", "I put on my hat.", "나는 모자를 썼어.", { img: "img/supplementary/put.webp", prompt: "a kid putting on a cap", art: "door" }),
    ],
  },
];
